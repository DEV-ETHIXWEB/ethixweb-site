...
// Lead-capture endpoint for the HVAC & plumbing campaign landing page
...
export const Route = createFileRoute("/api/landing/hvac-plumbing")({
  server: {
    handlers: {
      POST: createCampaignLeadHandler({
        routeId: "landing-hvac-plumbing",
